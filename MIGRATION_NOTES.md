...
- Uploaded files in Abacus storage must be copied to AWS S3 and database `cloud_storage_path` values must be preserved or remapped.
...
3. Configure S3 and verify uploads in preview.
